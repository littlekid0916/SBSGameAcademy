...
#pragma region 관계연산자
	...
	// 관계 연산자는 조건이 맞을 때 1 이라는 값으로 반환되며, 조건이 틀릴 때는 0이라는 값으로 반환

#pragma endregion

#pragma region if문
	// 어떤 특정한 조건을 비교하여 조건이 맞다면 실행
...
#pragma region else if문
	// if 문의 조건이 틀릴 때 else if문의 조건이 맞다면 실행
...
#pragma endregion
	...
	//switch (key)
	//{			
	//   // switch문은 해당 조건이 완료되었을 때, break문이 없으면 나머지 밑에 있는 case 문까지 계속 실행시카다가 종료
	//case 'W': printf("↑");
	//   break;
	//case 'A': printf("←");
	//   break;
